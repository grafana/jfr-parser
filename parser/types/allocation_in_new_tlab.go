...
var ExpectedMetaObjectAllocationInNewTLAB = &def.Class{
...
func (this *ObjectAllocationInNewTLAB) Parse(data []byte, typ *def.Class, typeMap map[def.TypeID]*def.Class, havecontextId bool) (pos int, err error) {
	var (
		v64_  uint64
		v32_  uint32
		s_    string
	...
	_ = v32_
	_ = s_
	nFields := len(ExpectedMetaObjectAllocationInNewTLAB.Fields)
	if !havecontextId {
		nFields -= 1
	}
