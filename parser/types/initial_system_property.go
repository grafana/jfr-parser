...
var ExpectedMetaInitialSystemProperty = &def.Class{
...
func (this *InitialSystemProperty) Parse(data []byte, typ *def.Class, typeMap map[def.TypeID]*def.Class) (pos int, err error) {
	var (
		v64_  uint64
		v32_  uint32
		s_    string
	...
	_ = v32_
	_ = s_
	nFields := len(ExpectedMetaInitialSystemProperty.Fields)
